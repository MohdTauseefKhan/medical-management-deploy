...
<head>
    <meta charset="UTF-8">
    <title>Sell Medicine - Medical Store</title>
    <style>
        body {
...
<body>
    ...
    %>
        ...
        <form action="SellMedicineServlet" method="post">
            <label for="id">Medicine Id:</label>
            <input type="number" name="id" id="id" required placeholder="Enter medicine id">
